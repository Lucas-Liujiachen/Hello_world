...
mmc2(part 0) is current device
Detect USB boot. Will enter fastboot mode!
Starting download of 196276 bytes
.
downloading of 196276 bytes finished
...
MMC write: dev # 2, block # 0, count 384 ... 384 blocks written: OK
...
mmc2(part 0) is current device
Detect USB boot. Will enter fastboot mode!
Starting download of 2359856 bytes
..................
downloading of 2359856 bytes finished
writing to partition 'bootloader'
Initializing 'bootloader'
switch to partitions #1, OK
mmc2(part 1) is current device
...
MMC write: dev # 2, block # 0, count 4610 ... 4610 blocks written: OK
Writing 'bootloader' DONE!
Detect USB boot. Will enter fastboot mode!
Detect USB boot. Will enter fastboot mode!
Detect USB boot. Will enter fastboot mode!
...
mmc2(part 0) is current device
Detect USB boot. Will enter fastboot mode!
Starting download of 1621312 bytes
............
downloading of 1621312 bytes finished
writing to partition 'bootloader'
Initializing 'bootloader'
switch to partitions #1, OK
mmc2(part 1) is current device
...
MMC write: dev # 2, block # 0, count 3167 ... 3167 blocks written: OK
Writing 'bootloader' DONE!
Detect USB boot. Will enter fastboot mode!
Detect USB boot. Will enter fastboot mode!
